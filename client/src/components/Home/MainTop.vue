  ...
  <div class="">
    ...
    <div class="flex p-3 rounded-md">
      <div class="w-full md:flex">
        <img :src="'https://image.tmdb.org/t/p/w500' + mainMovie.poster_path" alt="" class="">
      </div>
      <div class="w-full p-2 ml-3">
        <div class="flex">
          <div class="text-3xl">{{mainMovie.title}}</div>
          <div class="ml-auto text-xl">{{mainMovie.vote_average}} </div>
        ...
        <div>
          <div class="ml-3 text-sm text-left">개봉: {{ mainMovie.release_date}}</div>
