<template>
  <div class="w-full text-white" style="min-height:50vh;">
    <div class="w-full">
      ...
      <input class="w-full px-3 py-2 leading-tight text-gray-700 bg-white border rounded shadow appearance-none focus:outline-none focus:border-green-800" type="text" @input="inputTitle" id='title'>
    </div>
    <div class="w-full">
      <label class="block m-2 text-lg font-bold text-left text-white" for="content">내용 </label>
      <textarea class="w-full px-3 py-2 leading-tight text-gray-700 bg-white border rounded shadow appearance-none focus:outline-none focus:border-green-800" @input="inputContent" id='content' style="min-height:20vh"></textarea>
    </div>
