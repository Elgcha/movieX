<template>
  <div>
    <!-- 검색 -->
    <div class="flex w-1/3 mx-auto my-2">
    ...
    <div class="flex flex-wrap">
      <div v-for="movie in searchedMovies" :key="movie.id" @click="addMovie(movie.id)" class='grid grid-cols-2 gap-2 p-2 bg-gray-700 border cursor-pointer hover:bg-gray-600 flex-3 popular'>
